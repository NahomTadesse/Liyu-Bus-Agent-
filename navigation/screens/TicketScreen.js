...
const allin =()=>{
  ...
  const scaledTicket =()=>{
    return(
      <View style={ seat.length ==2 ? {transform: [{ scale: 0.8 }] , marginTop:-170,marginBottom:-150,marginLeft:35}
       : 
       seat.length ==3 ? {transform: [{ scale: 0.8 }] , marginTop:-260,marginBottom:-260,marginLeft:35} :
...
<View style={{flex:1,flexDirection:"column",marginLeft:20,marginRight:10}}>
  ...
  <View style={{flex:1,flexDirection:'row',marginBottom:5,height:35}}>
  ...
  <Text  style={{marginBottom:10,fontSize:22,fontWeight:'400'}}>Seat no. :-<Text style={{fontWeight:"500"}}>{'  '}{ticketInfo[index].seat}</Text></Text>
        ...
        <TouchableOpacity>
          ...
          >
            <View style={{ flexDirection: "column" }}>
              <Text style={{ marginTop: 10, color: "#006ED5", marginLeft: 25 }}>
                {loginD.fullName}
              </Text>
